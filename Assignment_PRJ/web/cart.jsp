        ...
        <div class="root bg-slate-300 relative pb-16">
            ...
            <form action="orderprocess" method="get">
                <div class="mt-16 mb-12 pt-12 pl-20 flex">
                    ...
                    <c:if test="${sessionScope.user != null && (sessionScope.cart.getList().size() > 0 || sessionScope.cart.getListService().size() > 0)}">
            ...
            <div class="pl-20 mb-6">
                <h1 class="text-5xl font-medium">Service Order</h1>
            </div>
            ...
            <div class="order-table flex justify-center mb-16">
                <table class="table-fixed w-10/12 rounded-t-lg overflow-hidden">
                    ...
                    <tbody>
                        <c:set var="step" value="0"/>
                        <c:forEach items="${sessionScope.cart.getListService()}" var="j">
                        <form method="post" action="cart-service-delete">
                            <c:set var="step" value="${step+1}"/>
                            <fmt:parseNumber var="num" type="number" value="${step}"/>
                            <tr class="${num % 2 == 0 ? 'bg-gray-200' : 'bg-gray-100'}">
                            <input type="hidden" name="id" value="${j.getId()}"/>
                            <td class="text-center p-3">${j.getName()}</td>
                            <td class="text-center p-3">
                                <fmt:formatNumber type="number" pattern=".##" value="${j.getPrice()}" />
                            </td>
                            <td class="text-center p-3">
                                <button class="text-white bg-red-600 hover:bg-red-500 px-3 py-1 rounded" type="submit">Delete</button>
                            </td>
                            </tr>
                        </form>
                    </c:forEach>
