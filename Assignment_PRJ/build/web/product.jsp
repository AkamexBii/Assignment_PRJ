    ...
    <body>
        ...
        <div class="root h-full bg-slate-300 relative">
            <div class="h-16 bg-zinc-900 w-screen py-3 px-8 fixed z-50 top-0" id="header">
                <div class="nav flex h-full justify-between">
                    ...
                    <div class="cart flex basis-1/6 ml-16 flex items-center">
                        ...
                        <span class="text-slate-100 rounded-xl bg-orange-700 px-2 py-1">${sessionScope.cart != null ? sessionScope.cart.getList().size() + sessionScope.cart.getListService().size() : 0}</span>
                    </div>
                </div>
            </div>
            ...
            <div class="mt-16 mb-4 pt-12 px-20 flex justify-between">
                ...
                <c:if test="${sessionScope.user.getRole() == 1}">
                    <div class="flex">
                        <a href="list-product" class="mx-4 bg-violet-600 text-white rounded hover:bg-violet-500 flex justify-center items-center px-6">View list product</a>
                                    ...
                                    <div class="item w-56 mb-6">
                                        <div class="image h-56 overflow-hidden relative">
                                            ...
                                            <div class="order w-full h-10 flex justify-center items-center">
                                                <c:if test="${sessionScope.user.getRole() != 1}">
                                                    <a href="product?id=${p.getId()}" class="cursor-pointer ml-2 py-1 px-6 bg-black rounded text-white">Detail</a>
                                            ...
                                            <div class="order w-full h-10 flex justify-center items-center">
                                                <c:if test="${sessionScope.user.getRole() != 1}">
                                                    <form action="product" method="get">
                                                        ...
                                                        <button type="submit" class="cursor-pointer ml-2 py-1 px-6 bg-black rounded text-white"">Detail</button>
                                                    </form>
                                                    <c:if test="${p.getUnitInStock() == 0}">
                                                        <button class="cursor-pointer ml-2 py-1 px-6 bg-black rounded text-white" onclick="showNotEnought()">Add</button>
                                                    </c:if>
