                ...
                <form action="updateproduct" method="post" enctype="multipart/form-data" class="max-w-3xl border-2 border-gray-400 rounded pb-10 shadow-2xl">
                    <table>
                        ...
                        <tr class="h-10 text-lg">
                            ...
                            <td colspan="2">
                                <input type="text" class="border-2 rounded w-full px-2" name="description" value="${requestScope.product.getDescription()}"/>
                            </td>
                        </tr>
                        <tr class="h-10 text-lg">
                        ...
                        <tr>
                            <td colspan="2" class="flex bottom-0">
                                <button type="button" onclick="handleDelete(${requestScope.product.getId()})" class="text-black bg-red-500 hover:bg-red-400 px-10 pb-2 pt-2 mt-2 rounded">Delete</button>         
                            </td>
                            <td colspan="2">
...
<script>
    function handleDelete(id) {
        const res = confirm("Confirm delete Product ID: " + id);
        
        if (res) window.location = "delete?id="+id;
    }
</script>